...
import com.example.myproject.ui.theme.FruitsAppTheme
            ...
            FruitsAppTheme() {
                Box(modifier = Modifier.fillMaxSize()) {
                    Column(
                        ...
                        HeadingTextComponent(value = "Name  : Rajinikanth")
                        Spacer(modifier = Modifier.height(15.dp))

                        HeadingTextComponent(value = "Email Id :rajinikanth@gmail.com")
                        Spacer(modifier = Modifier.height(15.dp))

                        HeadingTextComponent(value = "Location :united kingdom ")
                        Spacer(modifier = Modifier.height(15.dp))
                    }
